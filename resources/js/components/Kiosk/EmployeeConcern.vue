            ...
            <div v-show="show_concerns">
                ...
                <div class="grid-container">
                    <div v-for="(questionnaire, index) in questionnaires">
                        <div style="padding: 0em 0em 0em .5em;">
            ...
            <div v-show="show_concern_pendings">
                ...
                <div class="grid-container">
                    <div v-for="(survey_pending, index) in survey_pendings">
                        <div v-if="survey_pending.questionnaire_user_role == user_role" style="padding: 0em 0em 0em .5em;">
                        ...
                        <div v-else style="padding: 0em 0em 0em .5em;">
