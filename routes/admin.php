...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    */
    ...
    Route::get('/admin/reports/trend-report-by-daily/list', 'Admin\ReportsController@getTrendReportByDaily')->where('id', '[0-9]+')->name('admin.dashboard.trend-report-by-daily.list');
